...
#[ORM\Index(fields: ['pragmatic'])]
#[ORM\Index(fields: ['domestic'])]
#[ORM\Index(fields: ['traditional'])]
#[ORM\Index(fields: ['peaceful'])]
#[ORM\Index(fields: ['caring'])]
#[ORM\Index(fields: ['tolerant'])]
#[ORM\Index(fields: ['contemplative'])]
#[ORM\Index(fields: ['inquisitive'])]
#[ORM\Index(fields: ['experimental'])]
#[ORM\Index(fields: ['maximalist'])]
#[ORM\Index(fields: ['dominant'])]
#[ORM\Index(fields: ['ambitious'])]
#[ORM\Index(fields: ['tangible'])]
#[ORM\Index(fields: ['intangible'])]
#[ORM\Index(fields: ['relationships'])]
#[ORM\Index(fields: ['identity'])]
#[ORM\Index(fields: ['retention'])]
#[ORM\Index(fields: ['discovery'])]
#[ORM\Index(fields: ['others'])]
#[ORM\Index(fields: ['self'])]
#[ORM\Index(fields: ['safety'])]
#[ORM\Index(fields: ['confidence'])]
#[ORM\Index(fields: ['concord'])]
#[ORM\Index(fields: ['control'])]
#[ORM\Index(fields: ['languages'])]
#[ORM\Index(fields: ['sport'])]
#[ORM\Index(fields: ['math'])]
#[ORM\Index(fields: ['physics'])]
#[ORM\Index(fields: ['geography'])]
#[ORM\Index(fields: ['chemistry'])]
#[ORM\Index(fields: ['computers'])]
#[ORM\Index(fields: ['music'])]
